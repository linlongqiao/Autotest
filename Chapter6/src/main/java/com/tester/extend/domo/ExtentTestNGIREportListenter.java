...
public class ExtentTestNGIREportListenter implements IReporter{
/*
	 * private long currentTime = System.currentTimeMillis(); private
	 * SimpleDateFormat formatter = new SimpleDateFormat
	 * ("yyyy年-MM月-dd日-HH时mm分ss秒"); private Date date = new Date(currentTime);
    ...
    private String name = "Imooc lin Selenium 测试报告";
